...
import type { ResourceDetailModalProps as Props } from "@/types";
import { assetPath } from "@/lib/utils/assetPath";
import { NAVY_TILE } from "@/data/constants/styles";
import { PriceGrid } from "@/comps/ui/price-grid";

export function ResourceDetailModal({ resource, shipped, professionBonus, onClose }: Props) {
				...
				<div className="flex items-center gap-3">
					...
					<div>
						<div className="flex items-center gap-2">
							<span className="text-lg font-extrabold">{resource.name}</span>
							{shipped ? (
