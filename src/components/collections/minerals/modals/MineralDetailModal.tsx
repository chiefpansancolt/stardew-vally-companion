...
import { type MineralItem } from "stardew-valley-data";
...
export function MineralDetailModal({
	mineral,
	donated,
	found,
	geodeNames,
	...
	return (
		<Modal show={!!mineral} onClose={onClose} dismissible size="2xl">
			<ModalHeader>
			...
			<ModalBody>
				<div className="flex flex-col gap-5">
					...
					{geodeNames.length > 0 && (
						<div>
							<div className="mb-2 text-sm font-bold text-gray-900">Found In (Geodes)</div>
